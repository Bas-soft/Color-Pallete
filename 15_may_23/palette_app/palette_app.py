...
def app():
    ...
    def show_color(color):
        ...
        comple=(hsv[0]+0.5)%1.0

        compl_rgb=colorsys.hsv_to_rgb(comple,hsv[1],hsv[2])
        comple_color=tuple(int(c*255)for c in compl_rgb)


        cc = rgb2hex(int(comple_color[0]), int(comple_color[1]), int(comple_color[2]))
        eneterd=rgb2hex(int(color[0]), int(color[1]), int(color[2]))
        print(cc,eneterd)
